    ...
    render(){
        ...
        return[
            ...
            <div className="home-main">
                ...
                <h1 className="label-center space-above">{this.props.projects[0].category}</h1>
                <h2 className="label-center space-below">Explore {this.props.projects[0].category} from Seedbed's community.</h2>
