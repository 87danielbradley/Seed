    ...
    render(){
        return(
            ...
            <div className="rec-container">
                <div className="small-pic"> <Link to={`/projects/${this.props.project.id -1}`}><img src={this.props.project.url}/></Link></div>
                <div className="rec-stats">
                    <h1>{<Link to={`/projects/${this.props.project.id - 1}`} replace>{this.props.project.title}</Link>}</h1>
